$(function () {
    ...
    $(window).scroll(function () {
        ...
        // if (topWindow > $(".one-block").offset().top) {
        //     alert(1);
        // }
    });
    ...
    $(".thanks-messages-slider").slick({
        slidesToShow: 5,
        nextArrow: ".thanks-next",
        prevArrow: ".thanks-prev",
        responsive: [
            {
                breakpoint: 768,
                settings: {
        ...
        on: {
            ...
            slideChange: function () {
                if (this.activeIndex == 0) {
                    $(".swiper-wrapper").css("margin-left", "-70px");
                } else {
